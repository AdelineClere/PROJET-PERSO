                    ...
                    <hr>
                        <h2 id="edition">Edition</h2>
                            <div class="row">               
                                ...
                                <div class="col-md-3 col-sm-6 vignettes"> 
                                    <img class="img-responsive thumbnail" src="img/ed/e9.jpg" alt="" style="width:100%" onclick="openModal();currentSlide(7)" class="hover-shadow cursor">
                                </div> 
                                <div class="col-md-3 col-sm-6 vignettes"> 
                                    <img class="img-responsive thumbnail" src="img/ed/e10.jpg" alt="" style="width:100%" onclick="openModal();currentSlide(7)" class="hover-shadow cursor">
                                </div> 
                                <div class="col-md-3 col-sm-6 vignettes"> 
                                    <img class="img-responsive thumbnail" src="img/ed/e11.jpg" alt="" style="width:100%" onclick="openModal();currentSlide(7)" class="hover-shadow cursor">
                                </div> 
                                <div class="col-md-3 col-sm-6 vignettes"> 
                                    <img class="img-responsive thumbnail" src="img/ed/e12.jpg" alt="" style="width:100%" onclick="openModal();currentSlide(7)" class="hover-shadow cursor">
                                </div> 
                                <div class="col-md-3 col-sm-6 vignettes"> 
                                    <img class="img-responsive thumbnail" src="img/ed/e13.jpg" alt="" style="width:100%" onclick="openModal();currentSlide(7)" class="hover-shadow cursor">
                                </div> 
                                <div class="col-md-3 col-sm-6 vignettes"> 
                                    <img class="img-responsive thumbnail" src="img/ed/e14.jpg" alt="" style="width:100%" onclick="openModal();currentSlide(7)" class="hover-shadow cursor">
                                </div> 
                                <div class="col-md-3 col-sm-6 vignettes"> 
                                    <img class="img-responsive thumbnail" src="img/ed/e15.jpg" alt="" style="width:100%" onclick="openModal();currentSlide(7)" class="hover-shadow cursor">
                                </div> 
                                <div class="col-md-3 col-sm-6 vignettes"> 
                            ...
                            <div id="myModal2" class="modal">
                                ...
                                <div class="modal-content">
                                    ...
                                    <p id="caption"></p>
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed1.jpg" style="width:60%" onclick="currentSlide(8)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed2.jpg" style="width:60%" onclick="currentSlide(9)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed3.jpg" style="width:60%" onclick="currentSlide(10)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed4.jpg" style="width:60%" onclick="currentSlide(4)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed5.jpg" style="width:60%" onclick="currentSlide(5)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed6.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed7.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed8.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed9.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed10.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed11.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed12.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed13.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed14.jpg" style="width:60%" onclick="currentSlide(6)" alt="C">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed15.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed16.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed17.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed18.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        <img class="demo cursor" src="img/web/ed19.jpg" style="width:60%" onclick="currentSlide(6)" alt="">
                                        </div>
                                </div>
                            </div>
                    </div>
