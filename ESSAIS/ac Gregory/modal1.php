                        ...
                        <h2 id="web">Web</h2>
                            ...
                            <div class="row">               
                                    <div class="col-md-3 col-sm-6"> 
                                        <img id="myImgw1" class="img-responsive thumbnail" src="img/web/w1.jpg" alt="Codage html/css/Bootstrap/jquery" class="img-responsive">
                                        <!-- The Modal -->
                                        <div id="myModalw1" class="modal">
                                            <!-- The Close Button -->
                                            <span class="close">&times;</span>
                                            <!-- Modal Content (The Image) -->
                                            <img class="modal-content" id="imgw1">
                                            <!-- Modal Caption (Image Text) -->
                                            <div id="caption"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6"> 
                                        <img id="myImgw2" class="img-responsive thumbnail" src="img/web/w2.jpg" alt="Design Pause café tea time home" class="img-responsive">
...
// Get the modal
var modal = document.getElementById('myModalw1');

// Get the image and insert it inside the modal - use its "alt" text as a caption
var img = document.getElementById('myImgw1');
